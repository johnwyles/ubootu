    ...
    def __init__(self, stdscr):
        ...
        self.menu_items = [
            ...
            },
            {
                'id': '2',
                'label': 'Modify Setup',
                'description': 'Tweak your existing configuration',
                'icon': '🔧'
            },
            {
                'id': '3',
                'label': 'Apply Profile',
                'description': 'Restore from a saved configuration',
                'icon': '📦'
            },
            {
                'id': '4',
            ...
            },
            {
                'id': '5',
                'label': 'View History',
                'description': 'Browse configuration timeline',
                'icon': '📜'
            },
            {
                'id': '6',
                'label': 'Quick Actions',
                'description': 'Common tasks and fixes',
                'icon': '🎯'
            },
            {
                'id': '7',
