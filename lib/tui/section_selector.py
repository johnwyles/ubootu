...
class SectionSelector:
    ...
    def __init__(self, stdscr):
        ...
        self.sections = [
            {"id": "desktop", "label": "Desktop Environment", "description": "GNOME, KDE, XFCE, and more", "icon": "🖥️"},
            {
                "id": "applications",
                "label": "Applications",
            ...
            {"id": "security", "label": "Security & Privacy", "description": "Firewall, VPN, encryption", "icon": "🔒"},
            {"id": "themes", "label": "Themes & Appearance", "description": "Icons, fonts, wallpapers", "icon": "🎨"},
            {
                "id": "system",
