...
class DesktopMenuBuilder(MenuBuilder):
    ...
    def _build_window_managers(self):
        ...
        self.add_selectable(
            ...
            parent="wm-wayland",
            ansible_var="de_hyprland_enabled",
        )
        ...
        self.add_selectable(
            ...
            parent="wm-wayland",
            ansible_var="de_wayfire_enabled",
        )
        ...
        self.add_selectable(
            ...
            parent="wm-x11",
            ansible_var="de_awesome_enabled",
        )
        ...
        self.add_selectable(
            ...
            parent="wm-x11",
            ansible_var="de_openbox_enabled",
        )
    ...
    def _build_wallpapers(self):
        ...
        self.add_selectable(
            ...
            parent="wallpaper-collections",
            ansible_var="wallpaper_pack_abstract",
        )
        ...
        self.add_selectable(
            ...
            parent="wallpaper-collections",
            ansible_var="wallpaper_pack_nature",
        )
        ...
        self.add_selectable(
            ...
            parent="wallpaper-collections",
            ansible_var="wallpaper_pack_space",
        )
        ...
        self.add_selectable(
            ...
            parent="wallpaper-collections",
            ansible_var="wallpaper_pack_minimal",
        )
        ...
        self.add_selectable(
            ...
            parent="wallpaper-collections",
            ansible_var="wallpaper_dynamic_enabled",
        )
    ...
    def _build_shell_prompts(self):
        ...
        self.add_selectable(
            ...
            parent="shell-prompts",
            ansible_var="shell_prompt_starship",
        )
        ...
        self.add_selectable(
            ...
            parent="shell-prompts",
            ansible_var="shell_prompt_ohmyposh",
        )
        ...
        self.add_selectable(
            ...
            parent="shell-prompts",
            ansible_var="shell_prompt_spaceship",
        )
    ...
    def _build_icon_themes(self):
        ...
        self.add_selectable(
            ...
            parent="icon-themes",
            ansible_var="icon_theme_papirus",
        )
        ...
        self.add_selectable(
            ...
            "Colorful flat icons",
            parent="icon-themes",
            ansible_var="icon_theme_flatremix",
        )
    ...
    def _build_cursor_themes(self):
        ...
        self.add_selectable(
            ...
            "Breeze Cursors",
            "KDE default cursors",
            parent="cursor-themes",
            ansible_var="cursor_theme_breeze",
        )
        ...
        self.add_selectable(
            ...
            parent="cursor-themes",
            ansible_var="cursor_theme_bibata",
        )
        ...
        self.add_selectable(
            ...
            parent="cursor-themes",
            ansible_var="cursor_theme_capitaine",
        )
    ...
    def _build_terminal_themes(self):
        ...
        self.add_selectable(
            ...
            parent="terminal-themes",
            ansible_var="terminal_theme_dracula",
        )
        ...
        self.add_selectable(
            ...
            parent="terminal-themes",
            ansible_var="terminal_theme_catppuccin",
        )
        ...
        self.add_selectable(
            ...
            parent="terminal-themes",
            ansible_var="terminal_theme_nord",
        )
        ...
        self.add_selectable(
            ...
            "Retro groove colors",
            parent="terminal-themes",
            ansible_var="terminal_theme_gruvbox",
        )
    ...
    def _build_mouse_touchpad_settings(self):
        ...
        self.add_category(
            ...
            children=[
                ...
                "touchpad-tap-click",
                "touchpad-two-finger",
                "touchpad-edge-scroll",
                "touchpad-gestures",
                "touchpad-disable-typing",
            ],
        )
    ...
    def _build_effects_settings(self):
        ...
        self.add_configurable(
            ...
            config_type="dropdown",
            config_value="scale",
            config_options=[("scale", "Scale"), ("fade", "Fade"), ("none", "None")],
    ...
    def _build_panel_settings(self):
        ...
        self.add_configurable(
            ...
            config_type="dropdown",
            config_value="24h",
            config_options=[("12h", "12 Hour (AM/PM)"), ("24h", "24 Hour")],
