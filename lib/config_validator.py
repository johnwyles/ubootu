    ...
    def _validate_compatibility(self, config: BootstrapConfiguration, result: ValidationResult) -> None:
        ...
        de_compat = {
            ...
            DesktopEnvironment.KDE: {
                'themes': [GlobalTheme.DRACULA, GlobalTheme.NORD, GlobalTheme.CATPPUCCIN],
                'shells': [Shell.BASH, Shell.ZSH, Shell.FISH]
            }
        }
        ...
        if de in de_compat:
            ...
            if config.desktop.global_theme not in de_compat[de]['themes'] and config.desktop.global_theme != GlobalTheme.NONE:
        ...
        selected_heavy = [app for app in config.applications.multimedia_apps + config.applications.productivity_apps 
...
class SchemaValidator:
    ...
    def _validate_dict_against_schema(self, data: Dict[str, Any], schema: Dict[str, Any], 
    ...
    def _validate_field_against_schema(self, value: Any, schema: Dict[str, Any], 
                                     path: str, result: ValidationResult) -> None:
        ...
        return {
            ...
            "properties": {
                ...
                "development_languages": {
                    ...
                    "items": {
                        "type": "string",
                        "enum": ["python", "nodejs", "go", "rust", "java", "cpp", "javascript", "typescript"]
                    }
                },
