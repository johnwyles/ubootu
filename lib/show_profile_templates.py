...
def show_profile_templates():
    ...
    if HAS_RICH:
        ...
        title_text.append("\n\nChoose a pre-configured profile or create a custom configuration:", style="white")
        ...
        # Profile options
        profiles = [
            ("1", "🔧 Developer Profile", "IDEs, Git, Docker, programming languages, dev tools"),
            ("2", "🎮 Gaming Profile", "Steam, Discord, gaming utilities, media tools"),
            ("3", "🎨 Creative Profile", "GIMP, Blender, multimedia editing, design tools"),
            ("4", "🔒 Security Profile", "Security tools, hardening, privacy applications"),
            ("5", "⚡ Minimal Profile", "Just the essentials, lightweight setup"),
            ("c", "🛠️ Custom Configuration", "Choose exactly what you want (recommended)")
        ]
