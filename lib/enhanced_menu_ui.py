...
class EnhancedMenuUI:
    ...
    def _build_dev_tools_menu(self):
        ...
        self.menu_items["dev-tools"] = MenuItem(
            ...
            parent="development",
            is_category=True,
            children=["git", "docker", "postman", "insomnia", "dbeaver", "mysql-workbench", 
                     "pgadmin", "redis-desktop", "mongodb-compass", "github-desktop", 
                     "gitkraken", "smartgit", "lazygit", "gittyup"],
            emoji="🔧"
        )
    ...
    def _build_containers_menu(self):
        ...
        self.menu_items["dev-containers"] = MenuItem(
            ...
            parent="development",
            is_category=True,
            children=["docker-ce", "docker-compose", "kubernetes", "minikube", "helm", 
    ...
    def _build_modern_cli_menu(self):
        ...
        self.menu_items["dev-cli-modern"] = MenuItem(
            ...
            parent="development",
            is_category=True,
            children=["bat", "exa", "ripgrep", "fd", "dust", "duf", "procs", "bottom", 
                     "sd", "delta", "htop", "btop", "glances", "ncdu", "tldr", "fzf", 
                     "zoxide", "starship", "tmux", "zellij", "navi", "mcfly"],
            emoji="🚀"
        )
    ...
    def _build_ml_frameworks(self):
        ...
        self.menu_items["ml-frameworks"] = MenuItem(
            ...
            parent="ai-ml",
            is_category=True,
            children=["pytorch", "tensorflow", "jupyter-lab", "scikit-learn", "pandas-numpy", "huggingface-cli", "cuda-toolkit"],
            emoji="🧠"
        )
    ...
    def _build_fonts_menu(self):
        ...
        self.menu_items["font-packages"] = MenuItem(
            ...
            parent="fonts-config",
            is_category=True,
            children=["fonts-ubuntu", "fonts-noto", "fonts-liberation", "fonts-roboto", 
                     "fonts-firacode", "fonts-cascadia", "fonts-jetbrains"],
            emoji="📦"
        )
        ...
        for font_id, label, desc, default in system_fonts:
            self.menu_items[font_id] = MenuItem(
                font_id, label, desc,
                parent="font-packages",
                default=default
            )
        ...
        self.menu_items["nerd-fonts"] = MenuItem(
            ...
            parent="fonts-config",
            is_category=True,
            children=["nf-jetbrains", "nf-hack", "nf-firacode", "nf-cascadia", 
                     "nf-sourcecodepro", "nf-ubuntu", "nf-inconsolata", "nf-meslo"],
            emoji="🤓"
        )
        ...
        self.menu_items["font-settings"] = MenuItem(
            ...
            parent="fonts-config",
            is_category=True,
            children=["font-interface", "font-document", "font-monospace",
