...
class UbootuSplash:
    ...
    def show_rich_splash(self):
        ...
        console.print("\n[bright_green]✅ Ready! Loading options...[/bright_green]", justify="center")
        time.sleep(1)
    ...
    def show_terminal_splash(self):
        ...
        print(f"{colors['cyan']}{'Version ' + self.version + ' • Professional Ubuntu Desktop Configuration'.center(80)}{colors['end']}")
        print()
