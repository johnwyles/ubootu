...
class TestBuildMenuStructure:
    ...
    def test_root_menu_exists(self):
        ...
        assert root.children == ["development", "desktop", "applications", "security", "system"]
    
    def test_main_categories_exist(self):
        """Test that all main categories exist."""
        items = build_menu_structure()
        
        main_categories = ["development", "desktop", "applications", "security", "system", "actions"]
    ...
    def test_development_category_structure(self):
        ...
        assert dev.children == ["dev-ides", "dev-languages", "dev-tools", "dev-containers"]
    ...
    def test_actions_menu(self):
        ...
        assert actions.children == ["action-install", "action-save", "action-reset", "action-exit"]
