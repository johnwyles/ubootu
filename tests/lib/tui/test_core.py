...
class TestUbootuTUI:
    ...
    def mock_dependencies(self):
        ...
        with patch('lib.tui.core.MenuRegistry') as mock_registry, \
             patch('lib.tui.core.TUIConfigManager') as mock_config, \
             patch('lib.tui.core.TUIRenderer') as mock_renderer, \
             patch('lib.tui.core.TUIDialogs') as mock_dialogs, \
             patch('lib.tui.core.TUIEventHandler') as mock_handler:
...
class TestMain:
    ...
    @patch('lib.terminal_check.can_run_tui', return_value=(False, ["Terminal not compatible"], []))
