...
from lib.tui.constants import INDICATOR_NONE, INDICATOR_PARTIAL, INDICATOR_FULL
...
class TestSelectionIndicators:
    ...
    def test_subcategory_selection_indicators(self):
        ...
        assert prog_lang_indicator == INDICATOR_PARTIAL, f"Expected {INDICATOR_PARTIAL} for Programming Languages, got {prog_lang_indicator}"
        ...
        assert prog_lang_indicator == INDICATOR_NONE, f"Expected {INDICATOR_NONE} for Programming Languages, got {prog_lang_indicator}"
