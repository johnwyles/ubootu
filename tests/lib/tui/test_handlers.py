...
class TestTUIEventHandler:
    ...
    def sample_menu_items(self):
        ...
        return {
            ...
            "dev": MenuItem("dev", "Development", "Dev tools", parent="root", is_category=True, children=["python", "nodejs"]),
            "apps": MenuItem("apps", "Applications", "Apps", parent="root", is_category=True, children=["firefox"]),
            ...
            "actions": MenuItem("actions", "Actions", "Actions menu", parent="root", is_category=True, children=["action-install", "action-save", "action-reset", "action-exit"]),
            ...
            "configurable": MenuItem("configurable", "Config Item", "Configurable", is_configurable=True, config_type="slider", config_value=50)
        }
    ...
    def test_handle_key_navigation_up(self, mock_file, handler):
        ...
        menu_items = [
            handler.menu_items["dev"],
            handler.menu_items["apps"]
        ]
    ...
    def test_save_configuration(self, mock_yaml_dump, mock_file, handler):
        ...
        config_item = MenuItem(
            "swappiness", "Swappiness", "System swappiness",
            is_configurable=True, config_type="slider",
            config_value=10, config_unit="%",
