...
class TestFullUserJourney(unittest.TestCase):
    ...
    def test_help_overlay_integration(self):
        ...
        menu = UnifiedMenu(self.stdscr)
        menu.items = [
            {'id': 'vscode', 'label': 'VS Code', 'help': 'VS Code help text'}
        ]
        ...
        help_calls = [call for call in self.stdscr.addstr.call_args_list
                     if 'VS Code help text' in str(call)]
...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_invalid_terminal_size(self):
        ...
        error_calls = [call for call in self.stdscr.addstr.call_args_list
                      if 'Terminal too small' in str(call) or 
                      'minimum' in str(call).lower()]
...
class TestMenuNavigation(unittest.TestCase):
    ...
    def test_breadcrumb_navigation(self):
        ...
        breadcrumb_calls = [call for call in self.stdscr.addstr.call_args_list
                           if 'Development' in str(call) and 'Python' in str(call)]
