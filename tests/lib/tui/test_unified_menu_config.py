...
class TestUnifiedMenuConfig(unittest.TestCase):
    ...
    def test_spinner_dialog_opened(self, mock_spinner_class):
        ...
        mock_spinner.show.assert_called_once_with(
            'Tab Size', 4, [2, 4, 8], ''
        )
    ...
    def test_select_dialog_opened(self, mock_select_class):
        ...
        mock_select.show.assert_called_once_with(
            'Font Family',
            ['Monaco', 'Fira Code', 'JetBrains Mono'],
            'Monaco'
        )
...
class TestConfigPersistence(unittest.TestCase):
    ...
    def test_save_configuration(self):
        ...
        menu.selections = {
            'item1': True,
            'category1': {'subitem1', 'subitem2'}
        }
        menu.configurable_values = {
            'font-size': 16,
            'theme': 'Dark'
        }
    ...
    def test_load_config_overrides_defaults(self):
        ...
        test_config = {
            ...
            'configurable_items': {
                'config1': {'value': 20}  # Different value
            }
        }
