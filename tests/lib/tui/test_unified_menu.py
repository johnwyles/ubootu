...
class TestUnifiedMenu(unittest.TestCase):
    ...
    def test_help_system(self):
        ...
        menu = UnifiedMenu(self.stdscr)
        menu.items = [{"id": "vscode", "label": "Visual Studio Code", "help": "VS Code is a powerful editor"}]
        menu.current_index = 0
...
class TestMenuRendering(unittest.TestCase):
    ...
    def test_title_centering(self):
        ...
        title_calls = [call for call in self.stdscr.addstr.call_args_list if "Ubootu Configuration" in str(call)]
