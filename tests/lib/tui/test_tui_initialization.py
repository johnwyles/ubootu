...
class TestTUIInitialization(unittest.TestCase):
    ...
    def test_tty_detection_non_tty(self):
        ...
        result = subprocess.run([sys.executable, "configure_standard_tui.py"], capture_output=True, text=True)
    ...
    def test_help_works_without_tty(self):
        ...
        result = subprocess.run([sys.executable, "configure_standard_tui.py", "--help"], capture_output=True, text=True)
    ...
    def test_no_tui_flag(self):
        ...
        result = subprocess.run(
            [sys.executable, "configure_standard_tui.py", "--no-tui"], capture_output=True, text=True
        )
...
class TestFallbackBehavior(unittest.TestCase):
    ...
    def test_suggest_alternative_commands(self):
        ...
        self.assertTrue("setup.sh" in output or "alternative" in output.lower() or "try" in output.lower())
