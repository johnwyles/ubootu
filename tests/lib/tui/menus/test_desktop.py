"""
Unit tests for tui.menus.desktop - Desktop environment menu builder
"""
...
class TestDesktopMenuBuilder:
    """Test DesktopMenuBuilder menu builder"""

    @pytest.fixture
    def menu_builder(self):
        """Create menu builder instance"""
        return DesktopMenuBuilder()
