"""
Unit tests for tui.menus.system - System configuration menu builder
"""
...
class TestSystemMenuBuilder:
    """Test SystemMenuBuilder menu builder"""
    
    @pytest.fixture
    def menu_builder(self):
        """Create menu builder instance"""
        return SystemMenuBuilder()
