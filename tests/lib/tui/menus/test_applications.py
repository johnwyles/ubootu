"""
Unit tests for tui.menus.applications - Applications menu builder
"""
...
class TestApplicationsMenuBuilder:
    """Test ApplicationsMenuBuilder menu builder"""
    
    @pytest.fixture
    def menu_builder(self):
        """Create menu builder instance"""
        return ApplicationsMenuBuilder()
