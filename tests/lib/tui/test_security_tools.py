...
class TestSecurityTools(unittest.TestCase):
    ...
    def test_security_tools_have_warnings(self):
        ...
        security_tools = ['nmap', 'wireshark', 'john', 'hashcat', 'aircrack-ng', 
    ...
    def test_privacy_tools_separate_from_security_testing(self):
        ...
        for tool_id in privacy_defense_tools:
            ...
            if tool:
                ...
                parent = tool['parent']
                self.assertNotEqual(parent, 'security-testing',
                    f"{tool_id} should not be under security-testing")
    ...
    def test_security_categories_have_descriptions(self):
        ...
        security_categories = [
            'security-testing', 'network-security', 'web-security',
            'password-tools', 'wireless-security', 'forensics',
        ...
        for cat_id in security_categories:
            ...
            if cat:
                self.assertTrue(len(cat.get('description', '')) > 10,
                    f"Category {cat_id} has insufficient description")
