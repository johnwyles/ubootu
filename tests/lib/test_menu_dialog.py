...
class TestMenuDialog:
    ...
    def test_rendering(self, setup):
        ...
        if hasattr(lib.menu_dialog, 'render'):
            try:
                lib.menu_dialog.render(stdscr)
    ...
    def test_curses_wrapper(self, mock_wrapper):
        ...
        if hasattr(lib.menu_dialog, 'main'):
            lib.menu_dialog.main()
