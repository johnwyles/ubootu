...
class TestUnifiedMenuFunctional:
    ...
    def test_refresh_system_state(self, mock_discovery):
        ...
        mock_discovery.map_to_menu_items.return_value = {
            "firefox": "installed",
    ...
    def test_enter_submenu(self):
        ...
        self.menu.items = [
            {"id": "dev", "label": "Development", "is_category": True}
        ]
    ...
    def test_validate_config(self):
        ...
        # Valid config
        config = {
            "selections": {"firefox": True},
            "configurable_values": {"timeout": 30}
        }
