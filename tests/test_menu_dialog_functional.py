...
class TestMenuDialog:
    ...
    def test_show_menu_navigation_up(self):
        ...
        with patch("lib.menu_dialog.curses.curs_set"):
            ...
            self.stdscr.getch.side_effect = [curses.KEY_DOWN, curses.KEY_DOWN, curses.KEY_UP, ord("\n")]
    ...
    def test_show_menu_with_header_footer(self):
        ...
        with patch("lib.menu_dialog.curses.curs_set"):
            ...
            result = dialog.show("Test Menu", items, header_lines=header_lines, footer_lines=footer_lines)
    ...
    def test_show_menu_on_select_callback(self):
        ...
        with patch("lib.menu_dialog.curses.curs_set"):
            ...
            self.stdscr.getch.side_effect = [curses.KEY_DOWN, curses.KEY_DOWN, ord("\n")]
